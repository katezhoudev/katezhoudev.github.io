...
export class DishService {
  ...
  dishes: Dish[] = [
    ...
    {id: 4, title: ' 水煮牛肉', desc: 'traditional delicious dish', time: 20, serve: 5,
    steps: ['1）牛肉切横刀，放料酒、盐、酱油、少许油，加入淀粉拌匀。',
            '2）生菜洗净，掰片烫熟，铺在盘内做底。',
            '3）起油锅，加入两匙豆瓣酱翻炒，然后放入姜片，蒜，干辣椒和花椒翻炒，加入水烧开。',
            '4）加入牛肉，轻轻划散。至牛肉变色，水再次烧开。出锅，倒入生菜做底的盘中。',
            '5）洒些辣椒粉、花椒粉在表面，烧少许热油浇在辣椒粉和花椒粉上。最后加些葱花，香菜点缀即可上桌。'
          ]
    }
  ];
